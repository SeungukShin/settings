...
Plug 'Shougo/neomru.vim'			" unite for mru
Plug 'tsukkee/unite-tag'			" unite for tags
Plug 'amitab/vim-unite-cscope'			" unite for cscope
Plug 'hewes/unite-gtags'			" unite for global
Plug 'majutsushi/tagbar'			" tags
Plug 'http://repo.or.cz/vcscommand.git'		" vcs control
Plug 'mhinz/vim-signify'			" vcs mark
Plug 'osyo-manga/vim-anzu'			" search count
Plug 'kien/rainbow_parentheses.vim'		" paren color
Plug 'jiangmiao/auto-pairs'			" paren pair
call plug#end()
